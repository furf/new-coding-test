...
module.exports = {
  ...
  // cacheDirectory: "/private/var/folders/jf/821khjsj775f2scjy9xy9tfr0000gn/T/jest_dx",
  ...
  // Ignore styles when testing.
  // @see https://facebook.github.io/jest/docs/en/webpack.html
  moduleNameMapper: {
    '\\.(css|less)$': '<rootDir>/www/__mocks__/styleMock.js',
  },
  ...
  testPathIgnorePatterns: ['<rootDir>/node_modules/', '<rootDir>/www/.next/'],
